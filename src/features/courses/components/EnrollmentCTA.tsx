...
return ( <section className="overflow-hidden rounded-3xl bg-linear-to-r from-[#661093] via-[#7A1FA2] to-[#8B3CB8] text-white shadow-2xl"> <div className="grid gap-10 p-8 lg:grid-cols-[1.4fr_0.8fr] lg:p-12"> <div> <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em]"> <Sparkles className="h-3.5 w-3.5 text-[#D4AF37]" />
Enrollment open </div>
