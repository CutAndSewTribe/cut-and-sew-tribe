...
import { ContentGrid, ContentCard, PageHero } from "@/components/shared";
...
export default async function SearchPage({
  ...
  const { q = "", type, level, category } = await searchParams;
  ...
  return (
    <div>
      <PageHero
        label="Search"
        title={q ? `Results for "${q}"` : "Search Fashion Content"}
