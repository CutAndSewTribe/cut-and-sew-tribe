...
hero_image: string | null;      // ← add this
...
*
* This returns the course together with its published modules and lessons,
* allowing the curriculum section on the landing page to render correctly.
  */
  export async function getCourseLandingPageData(
  slug: string
  ): Promise<StudentCourseData | null> {
  return getStudentCourseBySlug(slug);
  }
